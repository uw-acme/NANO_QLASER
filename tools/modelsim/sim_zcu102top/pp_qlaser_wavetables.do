...
add wave -noupdate /tb_qlaser_top/u_qlaser_top/u_dacs_pulse/wave_errors
...
add wave -noupdate -radix unsigned /tb_qlaser_top/u_qlaser_top/u_dacs_pulse/g_ch(0)/ch_full/u_ch/sm_wavedata
add wave -noupdate /tb_qlaser_top/u_qlaser_top/u_dacs_pulse/g_ch(0)/ch_full/u_ch/axis_tlast
add wave -noupdate -radix unsigned /tb_qlaser_top/u_qlaser_top/u_dacs_pulse/g_ch(0)/ch_full/u_ch/ram_waveform_doutb
add wave -noupdate -radix hexadecimal /tb_qlaser_top/u_qlaser_top/u_dacs_pulse/g_ch(0)/ch_full/u_ch/ram_waveform_addrb
...
WaveRestoreCursors {{Cursor 1} {67995000000 fs} 0}
...
update
WaveRestoreZoom {67700036614 fs} {68397038973 fs}
