...
int iic_read_dac_reg(int nDac, int nReg)
{
    ...
    nReadData  = iic_read_cpld_reg(IIC_CPLD_REG_SPI_RD_1) << 8;
    nReadData  = nReadData + iic_read_cpld_reg(IIC_CPLD_REG_SPI_RD_0);
...
void dump_regs_fmc()
{
    ...
    //}
       ...
       (void)xil_printf("LMK04821[0] :  0x%04X\r\n",  nRdata);

       nRdata = iic_read_clk_reg(0x0003);
       (void)xil_printf("LMK04821[3] :  0x%04X\r\n",  nRdata);

       nRdata = iic_read_clk_reg(0x0004);
       (void)xil_printf("LMK04821[4] :  0x%04X\r\n",  nRdata);

       nRdata = iic_read_clk_reg(0x0005);
       (void)xil_printf("LMK04821[5] :  0x%04X\r\n",  nRdata);

       nRdata = iic_read_clk_reg(0x0006);
       (void)xil_printf("LMK04821[6] :  0x%04X\r\n",  nRdata);

       nRdata = iic_read_clk_reg(0x000C);
       (void)xil_printf("LMK04821[0xC] :  0x%04X\r\n",  nRdata);

       nRdata = iic_read_clk_reg(0x000D);
       (void)xil_printf("LMK04821[0xD] :  0x%04X\r\n",  nRdata);
