...
add wave -noupdate -radix unsigned /tb_qlaser_top/u_qlaser_top/u_dacs_pulse/g_ch(0)/ch_full/u_ch/ram_waveform_addrb
...
WaveRestoreCursors {{Cursor 1} {990921442 ps} 0}
...
update
WaveRestoreZoom {0 ps} {1009655281 ps}
