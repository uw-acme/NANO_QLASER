...
-- Date        : Wed Feb 28 12:17:32 2024
-- Host        : STATIONX2 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim e:/github/NANO_QLASER/prj/ip/clkpll_zcu/clkpll_zcu_sim_netlist.vhdl
-- Design      : clkpll_zcu
...
end clkpll_zcu_clk_wiz;

architecture STRUCTURE of clkpll_zcu_clk_wiz is
  signal clk_in1_clkpll_zcu : STD_LOGIC;
  signal clk_out1_clkpll_zcu : STD_LOGIC;
...
entity clkpll_zcu is
  ...
  attribute NotValidForBitStream of clkpll_zcu : entity is true;
end clkpll_zcu;

architecture STRUCTURE of clkpll_zcu is
begin
inst: entity work.clkpll_zcu_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
