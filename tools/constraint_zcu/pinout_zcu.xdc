...
## LEDs
set_property IOSTANDARD  LVCMOS33 [get_ports "p_leds[*]"] ;# Bank  44 VCCO 
...
set_property IOSTANDARD  LVCMOS33 [get_ports "p_debug_out[*]"] ;# Bank  50 VCCO
set_property PACKAGE_PIN H14      [get_ports "p_debug_out[0]"] ;# Bank  50 VCCO - VCC3V3   
set_property PACKAGE_PIN J14      [get_ports "p_debug_out[1]"] ;# Bank  50 VCCO - VCC3V3   
set_property PACKAGE_PIN G14      [get_ports "p_debug_out[2]"] ;# Bank  50 VCCO - VCC3V3   
set_property PACKAGE_PIN G15      [get_ports "p_debug_out[3]"] ;# Bank  50 VCCO - VCC3V3   
set_property PACKAGE_PIN J15      [get_ports "p_debug_out[4]"] ;# Bank  50 VCCO - VCC3V3   
set_property PACKAGE_PIN J16      [get_ports "p_debug_out[5]"] ;# Bank  50 VCCO - VCC3V3   
set_property PACKAGE_PIN G16      [get_ports "p_debug_out[6]"] ;# Bank  50 VCCO - VCC3V3   
set_property PACKAGE_PIN H16      [get_ports "p_debug_out[7]"] ;# Bank  50 VCCO - VCC3V3   
set_property PACKAGE_PIN G13      [get_ports "p_debug_out[8]"] ;# Bank  50 VCCO - VCC3V3  
set_property PACKAGE_PIN H13      [get_ports "p_debug_out[9]"] ;# Bank  50 VCCO - VCC3V3  
