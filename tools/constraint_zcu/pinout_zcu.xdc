...
set_property PACKAGE_PIN A22      [get_ports "p_dc0_sclk"] ;# Bank  47 VCCO - VCC3V3   - IO_L11N_AD1N_47
set_property IOSTANDARD  LVCMOS33 [get_ports "p_dc0_sclk"] ;# Bank  47 VCCO - VCC3V3   - IO_L11N_AD1N_47
set_property PACKAGE_PIN A21      [get_ports "p_dc1_cs_n"] ;# Bank  47 VCCO - VCC3V3   - IO_L11P_AD1P_47
set_property IOSTANDARD  LVCMOS33 [get_ports "p_dc1_cs_n"] ;# Bank  47 VCCO - VCC3V3   - IO_L11P_AD1P_47
set_property PACKAGE_PIN B21      [get_ports "p_dc1_mosi"] ;# Bank  47 VCCO - VCC3V3   - IO_L10N_AD2N_47
set_property IOSTANDARD  LVCMOS33 [get_ports "p_dc1_mosi"] ;# Bank  47 VCCO - VCC3V3   - IO_L10N_AD2N_47
set_property PACKAGE_PIN C21      [get_ports "p_dc1_sclk"] ;# Bank  47 VCCO - VCC3V3   - IO_L10P_AD2P_47
set_property IOSTANDARD  LVCMOS33 [get_ports "p_dc1_sclk"] ;# Bank  47 VCCO - VCC3V3   - IO_L10P_AD2P_47
...
set_property PACKAGE_PIN D22      [get_ports "p_dc2_sclk"] ;# Bank  47 VCCO - VCC3V3   - IO_L7N_HDGC_AD5N_47
set_property IOSTANDARD  LVCMOS33 [get_ports "p_dc2_sclk"] ;# Bank  47 VCCO - VCC3V3   - IO_L7N_HDGC_AD5N_47

# UART
set_property PACKAGE_PIN E13      [get_ports "p_serial_txd"] ;# Bank  49 VCCO - VCC3V3   - IO_L12N_AD8N_49
set_property IOSTANDARD  LVCMOS33 [get_ports "p_serial_txd"] ;# Bank  49 VCCO - VCC3V3   - IO_L12N_AD8N_49
set_property PACKAGE_PIN F13      [get_ports "p_serial_rxd"] ;# Bank  49 VCCO - VCC3V3   - IO_L12P_AD8P_49
set_property IOSTANDARD  LVCMOS33 [get_ports "p_serial_rxd"] ;# Bank  49 VCCO - VCC3V3   - IO_L12P_AD8P_49
